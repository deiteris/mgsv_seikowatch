  ...
  for (var ii = 0; ii < 4; ii++) {
    ...
    switch (ii) {
      case 0:
        ...
        $('.sec2').css(
          'background-position', (-nums.w * num2) + 'px 0px'
        );
        $('.sec1').css(
          'background-position', (-nums.w * num1) + 'px 0px'
        );
        break;
      case 1:
        $('.min2').css(
          'background-position', (-numl.w * num2) + 'px 0px'
        );
        $('.min1').css(
          'background-position', (-numl.w * num1) + 'px 0px'
        );
        break;
      case 2:
        $('.hour2').css(
      ...
      case 3:
        $('.day2').css(
          'background-position', (-numl.w * days_hi) + 'px 0px'
        );
        $('.day1').css(
          'background-position', (-numl.w * days_lo) + 'px 0px'
        );
        break;
    }
  }
